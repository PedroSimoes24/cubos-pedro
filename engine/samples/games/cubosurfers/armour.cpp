...
void armourPlugin(Cubos& cubos)
{
    ...
    cubos.system("move armour")
        .call([](Commands cmds, const DeltaTime& dt, Query<Entity, const Armour&, Position&> armourPowerups) {
            for (auto [ent, armour, position] : armourPowerups)
            {
